...
from utils.edgar_client_extraction import EdgarClientExtraction
...
edgar = EdgarClientExtraction(email=EMAIL)

data_10k = edgar.fetch_filing_data("TSLA", "10-K")
text_10k = edgar.get_combined_text(data_10k)

data_10q = edgar.fetch_filing_data("TSLA", "10-Q")
