...
import trafilatura  ## ferramenta especializada em extrair conteudo textual de paginas web, garantindo que o texto seja limpo e relevante para análise.
import yfinance as yf


class YahooClientExtraction:
